...
API_KEY='AIzaSyBvtuKefn9l6DJrbhfkU6RwRfhi6NwfERQ'
...
# MongoDB Connection
arun = pg.MongoClient("mongodb://arun:arunpunk@ac-eeemcqf-shard-00-00.d8psc9m.mongodb.net:27017,ac-eeemcqf-shard-00-01.d8psc9m.mongodb.net:27017,ac-eeemcqf-shard-00-02.d8psc9m.mongodb.net:27017/?ssl=true&replicaSet=atlas-4bxt5v-shard-0&authSource=admin&retryWrites=true&w=majority")

# Creating database
db  = arun["Youtube_Database"]
...
if submit1:
    ...
    #MySQL Database Connection:
        ...
        engine = create_engine('mysql+mysqlconnector://root:arun1998@localhost/youtube_data')
...
elif questions == '7. What are the names of all the channels that have published videos in the year 2022?':
...
elif questions =='8. Which videos have the highest number of comments, and what are their corresponding channel names?':
